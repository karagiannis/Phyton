...
def get_line_chart(book, start_row, end_row, labels_col, data_col, title, sheet_name):
    chart = book.add_chart({'type' : 'line'})
    chart.add_series({
        'categories' : [sheet_name, start_row, labels_col, end_row, labels_col],
        'values' : [sheet_name, start_row, data_col, end_row, data_col],
        'line' : {'color': 'blue'}
    })
